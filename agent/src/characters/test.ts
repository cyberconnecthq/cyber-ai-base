...
export const test: Character = {
  ...
  You can draw picture for users`,
    ...
    templates: {
        textAndImageRespondTemplate:
            `# INSTRUCTIONS: Determine if {{agentName}} (@{{twitterUserName}}) should respond to the message and participate in the conversation or generate image or draw a picture. Do not comment.

Response options are TEXT, TEXTANDIMAGE, IGNORE and STOP .
